...
EXPORT_SYMBOL_GPL(reset_charger2_pd_power_data);
#endif
...
void PolicySinkEvaluateCaps(Port_t *port)
{
    ...
    for (i = 0; i < port->SrcCapsHeaderReceived.NumDataObjects; i++)
    {
        ...
        case pdoTypeFixed:
            ...
            pr_info("batt_sys: sec-usbpd-list fixed %d : volt %d, curr %d, power %d\n",
    ...
    pr_info("batt_sys: sec-usbpd-list max fixed power %d, 5v obj %dmA, 9v obj %dmA\n",
