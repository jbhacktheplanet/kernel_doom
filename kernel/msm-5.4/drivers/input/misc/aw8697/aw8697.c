...
static char aw8697_rtp_name[][AW8697_RTP_NAME_MAX] = {
	{"59_Test.bin"}, 
	{"60_Haptic_Right_RTP.bin"}, /* 60 */
	{"61_Haptic_Right_RTP.bin"},
	{"62_Haptic_Right_RTP.bin"},
	{"63_Haptic_Right_RTP.bin"},
	{"64_Haptic_Right_RTP.bin"},
	{"65_Haptic_Right_RTP.bin"},
	{"66_Haptic_Right_RTP.bin"},
	{"67_Haptic_Right_RTP.bin"},
	{"68_Haptic_Right_RTP.bin"},
	{"69_Haptic_Right_RTP.bin"},
	{"70_Haptic_Right_RTP.bin"},
	{"71_Haptic_Right_RTP.bin"},
	{"72_Haptic_Right_RTP.bin"},
	{"73_Haptic_Right_RTP.bin"},
	{"74_Haptic_Right_RTP.bin"},
	{"75_Haptic_Right_RTP.bin"},
	{"76_Haptic_Right_RTP.bin"},
	{"77_Haptic_Right_RTP.bin"},
	{"78_Haptic_Right_RTP.bin"},
	{"79_Haptic_Right_RTP.bin"},
	{"80_Haptic_Right_RTP.bin"},
	{"81_Haptic_Right_RTP.bin"},
	{"82_Haptic_Right_RTP.bin"},
	{"83_Haptic_Right_RTP.bin"},
	{"84_Haptic_Right_RTP.bin"},
	{"85_Haptic_Right_RTP.bin"},
	{"86_Haptic_Right_RTP.bin"},
	{"87_Haptic_Right_RTP.bin"},
	{"88_Haptic_Right_RTP.bin"},
	{"89_Haptic_Right_RTP.bin"},
	{"90_Haptic_Right_RTP.bin"},
	{"91_Haptic_Right_RTP.bin"},
	{"92_Haptic_Right_RTP.bin"},
	{"93_Haptic_Right_RTP.bin"},
	{"94_Haptic_Right_RTP.bin"},
	{"95_Haptic_Right_RTP.bin"},
	{"96_Haptic_Right_RTP.bin"},
	{"97_Haptic_Right_RTP.bin"},
	{"98_Haptic_Right_RTP.bin"},
	{"99_Haptic_Right_RTP.bin"},
	{"100_Haptic_Right_RTP.bin"},
		...
		if (!aw8697_haptic_rtp_get_fifo_afi(aw8697)) {
			...
			if (aw8697->rtp_cnt != aw8697_rtp->len) {
				if (aw8697->timeval_flags == 1) {
					//do_gettimeofday64(&aw8697->start);
	...
	if (event == 11) {
		pr_debug("%s: tp down\n", __func__);
			...
			if((AW8697_HAPTIC_TP_ST_PRESS == record_point[i].status) &&
				...
				//do_gettimeofday64(&tp->id[i].t_press);
	...
	if (event == 10) {
		pr_debug("%s: tp up\n", __func__);
			...
			if((AW8697_HAPTIC_TP_ST_RELEASE == record_point[i].status) &&
				...
				//do_gettimeofday64(&tp->id[i].t_release);
				pr_debug("%s: tp_press_release: status=%d, flag=%d", __func__, tp->id[i].pt_info.status, tp->id[i].tp_flag);
			}
	}
	if (event == 0) {
